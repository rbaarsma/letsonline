...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'E:\\HostingSpaces\\Baarsma\\letsonline.nl\\wwwroot\\symfony\\log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'E:\\HostingSpaces\\Baarsma\\letsonline.nl\\wwwroot\\symfony\\cache\\frontend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'E:\\HostingSpaces\\Baarsma\\letsonline.nl\\wwwroot\\symfony\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'E:\\HostingSpaces\\Baarsma\\letsonline.nl\\wwwroot\\symfony\\cache\\frontend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'E:\\HostingSpaces\\Baarsma\\letsonline.nl\\wwwroot\\symfony\\apps\\frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 25,
      'encryption' => NULL,
      'username' => 'noreply@letsonline.nl',
      'password' => 'j210F8s91',
    ),
  ),
  'delivery_address' => 'solidwebcode@gmail.com',
))));
